...
public class PLTextProvider implements TextProvider {

  @Override
  public String askForClientsName() {
    return "Podaj nazwę klienta (ty, pojedyncze słowo) : ";
  }
  ...
  public String askForInput(String username) {
    String GorgeProofing = ConsoleColors.YELLOW+ """
        ...
        Dodaj blok do blokchainu : /block --create [indeks transakcji]
        Wylistuj bloki : /block --list-all
        Więcej opcji opisanych w dokumentacji : /help
        Wyjdź z aplikacji : /quit
        """ + ConsoleColors.RESET;
